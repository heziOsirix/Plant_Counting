...
from ..Pre_Treatments import Process_image_for_FT as PiFT
from ..Fourier import FrequencyAnalysis as FA
from ..MAS import Multi_Images_Simulation as MIS
from ..Utility import general_IO as gIO

import json
from PIL import Image
Image.MAX_IMAGE_PIXELS = 5801503664
...
# =============================================================================
    CompleteProcess(_path_input_rgb_img="../Tutorial/Data/Non-Labelled/plot_18",
                    _path_output_root="../Tutorial/Output_General/plot_18",
                    ...
                    _RAs_group_size=20, _RAs_group_steps=1, _Simulation_steps=50,
                    _RALs_fuse_factor=0.5, _RALs_fill_factor=1.5)
